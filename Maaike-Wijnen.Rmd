...
```{r echo = FALSE, include = FALSE, message = FALSE, warning = FALSE}
forms_filtered <- filter(forms, naam == "Maaike Wijnen")
```
...
knitr::include_graphics("images/gerechten/Maaike Coen_Maaike Wijnen-1.jpg")
```

```{r echo = FALSE, message = FALSE, warning = FALSE, fig.align = 'center'}

knitr::include_graphics("images/gerechten/Maaike Coen_Maaike Wijnen-2.jpg")
```


```{r echo = FALSE, message = FALSE, warning = FALSE, fig.align = 'center'}
knitr::include_graphics("images/gerechten/Maaike Coen_Maaike Wijnen-3.jpg")
```

```{r echo = FALSE, message = FALSE, warning = FALSE, out.width = "100%", fig.align = 'center'}
foto_persoon <- forms_filtered$foto_persoon

knitr::include_graphics(foto_persoon)
```