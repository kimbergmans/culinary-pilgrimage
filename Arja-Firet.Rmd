...
```{r echo = FALSE, include = FALSE, message = FALSE, warning = FALSE}
forms_filtered <- filter(forms, naam == "Arja Firet")
```
...
knitr::include_graphics("images/gerechten/Gerechtje Arja 1_Arja Firet.jpg")
```

```{r echo = FALSE, message = FALSE, warning = FALSE, out.width = "100%", fig.align = 'center'}
knitr::include_graphics("images/gerechten/Gerechtje Arja 2_Arja Firet.jpg")
```

```{r echo = FALSE, message = FALSE, warning = FALSE, out.width = "100%", fig.align = 'center'}
knitr::include_graphics("images/gerechten/Gerechtje Arja 3_Arja Firet.jpg")
```

```{r echo = FALSE, message = FALSE, warning = FALSE, fig.align = 'center'}
# foto_persoon <- forms_filtered$foto_persoon

knitr::include_graphics("images/people/IMG_4224_Arja Firet.JPG")
```

```{r echo = FALSE, message = FALSE, warning = FALSE, fig.align = 'center'}

knitr::include_graphics("images/people/UB 2021-019 Arja Firet_Arja Firet.jpg")
```