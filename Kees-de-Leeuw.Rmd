...
```{r echo = FALSE, include = FALSE, message = FALSE, warning = FALSE}
forms_filtered <- filter(forms, naam == "Kees de Leeuw")
```
...
knitr::include_graphics("images/people/Kees de Leeuw portret_Kees de Leeuw.jpg")
```

```{r echo = FALSE, message = FALSE, warning = FALSE, out.width = "100%", fig.align = 'center'}
#foto_persoon <- forms_filtered$foto_persoon

knitr::include_graphics("images/people/Slechtvalk in Amersfoort._Kees de Leeuw.JPG")
```

```{r echo = FALSE, message = FALSE, warning = FALSE, out.width = "100%", fig.align = 'center'}
#foto_persoon <- forms_filtered$foto_persoon

knitr::include_graphics("images/people/Vos gespot door Kees nabij Almere_Kees de Leeuw.JPG")
```