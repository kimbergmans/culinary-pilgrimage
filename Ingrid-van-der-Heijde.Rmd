...
```{r echo = FALSE, include = FALSE, message = FALSE, warning = FALSE}
forms_filtered <- filter(forms, naam == "Ingrid van der Heijde")
```
...
knitr::include_graphics("images/gerechten/Gartine-Ingrid_Ingrid van der Heijd.jpg")
```

```{r echo = FALSE, message = FALSE, warning = FALSE, fig.align = 'center'}
knitr::include_graphics("images/gerechten/Ingrid-restaurantGartine_Ingrid van der Heijd.jpg")
```
