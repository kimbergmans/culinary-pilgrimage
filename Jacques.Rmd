...
```{r echo = FALSE, include = FALSE, message = FALSE, warning = FALSE}
forms_filtered <- filter(forms, naam == "Jacques")
```
...
knitr::include_graphics("images/gerechten/jacques_ceviche_Jacques Flores.JPG")
```
```{r echo = FALSE, message = FALSE, warning = FALSE, out.width = "100%", fig.align = 'center'}
#foto_gerecht <- forms_filtered$foto_gerecht

knitr::include_graphics("images/gerechten/jacques_seco_Jacques Flores.jpg")
```
